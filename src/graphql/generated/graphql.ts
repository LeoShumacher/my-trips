...
export type GetPageBtSlugQueryVariables = Exact<{
  slug: Scalars['String']['input'];
}>;


export type GetPageBtSlugQuery = { __typename?: 'Query', page?: { __typename?: 'Page', id: string, slug: string, heading: string, body: { __typename?: 'RichText', html: string } } | null };
